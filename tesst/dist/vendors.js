...
const convert = (val) => Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__[/* isObject */ "v"])(val) ? reactive(val) : val;
function isRef(r) {
...
function computed(getterOrOptions, debugOptions) {
    ...
    const cRef = new ComputedRefImpl(getter, setter, Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__[/* isFunction */ "p"])(getterOrOptions) || !getterOrOptions.set);
...
/*! exports used: BaseTransition, Fragment, Static, callWithAsyncErrorHandling, createElementBlock, createElementVNode, createHydrationRenderer, createRenderer, createVNode, defineComponent, getCurrentInstance, getTransitionRawChildren, h, inject, isRuntimeOnly, nextTick, onMounted, onUnmounted, onUpdated, openBlock, resolveComponent, resolveTransitionHooks, setTransitionHooks, useTransitionState, warn, watch, watchPostEffect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return createElementBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return createBaseVNode; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return watchPostEffect; });
...
const deprecationData = {
    ...
    ["COMPONENT_V_MODEL" /* COMPONENT_V_MODEL */]: {
        message: (comp) => {
            ...
            if (comp.props &&
                (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isArray */ "o"])(comp.props)
...
function isCompatEnabled(key, instance, enableForBuiltIn = false) {
    ...
    const mode = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isFunction */ "p"])(rawMode)
...
function createAttrsProxy(instance) {
    return new Proxy(instance.attrs, ( true)
        ? {
            get(target, key) {
                markAttrsAccessed();
                Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* track */ "q"])(instance, "get" /* GET */, '$attrs');
                return target[key];
            },
            set() {
