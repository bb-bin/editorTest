...
prevChildren, parentComponent, parentSuspense, unmountChildren) {
    ...
    try {
        ...
        if ((true)) {
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`Failed setting prop "${key}" on <${el.tagName.toLowerCase()}>: ` +
...
function defineCustomElement(options, hydate) {
    const Comp = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* defineComponent */ "j"])(options);
...
class VueElement extends BaseClass {
    constructor(_def, _props = {}, hydrate) {
        ...
        if (this.shadowRoot && hydrate) {
            ...
            if (( true) && this.shadowRoot) {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`Custom element has pre-rendered declarative shadow root but is not ` +
    ...
    disconnectedCallback() {
        this._connected = false;
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* nextTick */ "p"])(() => {
            if (!this._connected) {
    ...
    _resolveDef() {
        ...
        const resolve = (def) => {
            ...
            const rawKeys = props ? (Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isArray */ "o"])(props) ? props : Object.keys(props)) : [];
    ...
    _setAttr(key) {
        this._setProp(Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* camelize */ "e"])(key), Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* toNumber */ "M"])(this.getAttribute(key)), false);
    }
    /**
     * @internal
     */
    ...
    _createVNode() {
        const vnode = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* createVNode */ "i"])(this._def, Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* extend */ "h"])({}, this._props));
        if (!this._instance) {
            vnode.ce = instance => {
...
function useCssModule(name = '$style') {
    /* istanbul ignore else */
    {
        ...
        if (!instance) {
            ( true) && Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`useCssModule must be called inside setup()`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        const modules = instance.type.__cssModules;
        if (!modules) {
            ( true) && Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`Current instance does not have CSS modules injected.`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        const mod = modules[name];
        if (!mod) {
            ( true) &&
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`Current instance does not have CSS module named "${name}".`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        return mod;
    }
...
function useCssVars(getter) {
    ...
    if (!instance) {
        ( true) &&
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`useCssVars is called without current active component instance.`);
        return;
    }
    const setVars = () => setVarsOnVNode(instance.subTree, getter(instance.proxy));
    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* watchPostEffect */ "A"])(setVars);
    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onMounted */ "q"])(() => {
        const ob = new MutationObserver(setVars);
        ob.observe(instance.subTree.el.parentNode, { childList: true });
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onUnmounted */ "r"])(() => ob.disconnect());
    });
}
...
const TransitionGroupImpl = {
    ...
    setup(props, { slots }) {
        ...
        let prevChildren;
        let children;
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onUpdated */ "s"])(() => {
        ...
        return () => {
            ...
            for (let i = 0; i < children.length; i++) {
                ...
                if (child.key != null) {
                    ...
                    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`<TransitionGroup> children must be keyed.`);
                }
            }
            if (prevChildren) {
...
function setSelected(el, value) {
    ...
    if (isMultiple && !Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isArray */ "o"])(value) && !Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isSet */ "B"])(value)) {
        ( true) &&
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`<select multiple v-model> expects an Array or Set value for its binding, ` +
...
function ensureRenderer() {
    return (renderer ||
        (renderer = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* createRenderer */ "h"])(rendererOptions)));
}
...
function injectCompilerOptionsCheck(app) {
    if (Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* isRuntimeOnly */ "o"])()) {
        ...
        Object.defineProperty(app.config, 'isCustomElement', {
            ...
            set() {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`The \`isCustomElement\` config option is deprecated. Use ` +
        ...
        Object.defineProperty(app.config, 'compilerOptions', {
            get() {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(msg);
...
function normalizeContainer(container) {
    if (Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isString */ "D"])(container)) {
        ...
        if (( true) && !res) {
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`Failed to mount app: mount target selector "${container}" returned null.`);
        }
        return res;
    }
    if (( true) &&
        ...
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "y"])(`mounting on a ShadowRoot with \`{mode: "closed"}\` may lead to unpredictable bugs`);
    }
    return container;
}
...
function useStore (key) {
  ...
  return Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "n"])(key !== null ? key : storeKey)
}
...
var inst = App(Object(_tarojs_runtime__WEBPACK_IMPORTED_MODULE_1__["createVue3App"])(_node_modules_babel_loader_lib_index_js_app_ts__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], vue__WEBPACK_IMPORTED_MODULE_4__[/* h */ "m"], config))
